<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Ppal.Master" AutoEventWireup="true"
    CodeBehind="Lista.aspx.cs" Inherits="SIGED_3.CRM.Web.Modulos.Bodega.Lista" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.: Bodega Lista :.</title>
</asp:Content>
                ...
                <tr>
                    <th>Bodegas
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="Seleccionar_LP" TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.BodegaFachada">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="rdEstado" Name="Estado" PropertyName="Checked" Type="Boolean" />
                                <asp:SessionParameter DefaultValue="0" Name="Id_GrupoDeMiembros" SessionField="IdGM"
                                    Type="Int64" />
