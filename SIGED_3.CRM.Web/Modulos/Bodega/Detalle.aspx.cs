...
namespace SIGED_3.CRM.Web.Modulos.Bodega
{
    public partial class Detalle : System.Web.UI.Page
    {
        ...
        protected void frmPpal_DataBound(object sender, EventArgs e)
        {
            ...
            {
                SIGED_3.CRM.Model.Negocio.Entidades.Bodega objBodega = (SIGED_3.CRM.Model.Negocio.Entidades.Bodega)frmPpal.DataItem;
                if (objBodega.Id_Provincia != null)
                {
                    ((RadComboBox)frmPpal.FindControl("cboProvincia")).SelectedValue = objBodega.Id_Provincia.ToString();
                    ((RadComboBox)frmPpal.FindControl("cboCiudad")).DataBind();
                    ((RadComboBox)frmPpal.FindControl("cboCiudad")).SelectedValue = objBodega.Id_Ciudad.ToString();
                }

            }
            new Genericos().ConfigurarPermisosDetalle(frmPpal, "InsertButton", "UpdateButton", (int)Modulo_Enum.Bodegas, 1);
        }
