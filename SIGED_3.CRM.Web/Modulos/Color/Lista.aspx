<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Ppal.Master" AutoEventWireup="true"
    CodeBehind="Lista.aspx.cs" Inherits="SIGED_3.CRM.Web.Modulos.Color.Lista" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.: Color Lista :.</title>
</asp:Content>
                ...
                <tr>
                    <th>
                        ...
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="Seleccionar_LP" TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.ColorFachada">
                            <SelectParameters>
                                ...
                                <asp:GridView ID="gvPrincipal" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="Color" SortExpression="Color">
                                            <ItemTemplate>
                                                <div id="gcColor" runat="server" style="width: 99px; height: 19px; border: 1px solid #000;
