<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Details.Master" AutoEventWireup="true"
    CodeBehind="Detalle.aspx.cs" Inherits="SIGED_3.CRM.Web.Modulos.Cliente.Detalle" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="FormulariosTextos">
        <table>
            <thead>
                <tr>
                    <th>Cliente<asp:ObjectDataSource ID="ObjectDataSource1" runat="server" DataObjectTypeName="SIGED_3.CRM.Model.Negocio.Entidades.Cliente"
                        InsertMethod="Guardar_2" OldValuesParameterFormatString="original_{0}" SelectMethod="Seleccionar_Id"
                        TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.ClienteFachada" UpdateMethod="Actualizar"
                                ...
                                <asp:FormView ID="frmPpal" runat="server" DataSourceID="ObjectDataSource1" DefaultMode="Insert"
                                    ...
                                    <EditItemTemplate>
                                        <telerik:RadTabStrip ID="RadTabStrip1" runat="server" MultiPageID="rmpEditar" SelectedIndex="0">
                                            <Tabs>
                                                <telerik:RadTab runat="server" PageViewID="rpvCliente" Text="Cliente" Selected="True">
                                                </telerik:RadTab>
                                        ...
                                        <telerik:RadMultiPage ID="rmpEditar" runat="server" SelectedIndex="0">
                                            <telerik:RadPageView ID="rpvCliente" runat="server">
                                                ...
                                                <table>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left;">
                                                            <telerik:RadComboBox ID="cboTipoDeDocumento" runat="server" DataSourceID="ObjectDataSource4"
                                                                DataTextField="Nombre" DataValueField="Id" SelectedValue='<%# Bind("Id_TipoDeDocumento") %>'>
                                                            </telerik:RadComboBox>
                                                    ...
                                                    <tr>
                                                        <td style="text-align: right;">
                                                            <asp:Label ID="Label13" runat="server" Text="Precio al que se vende"></asp:Label>
                                                        </td>
                                                        <td style="text-align: left;">
                                                            <telerik:RadComboBox ID="cboPrecioQueSeVende" runat="server" SelectedValue='<%# Bind("PrecioQueSeVende") %>' DataSourceID="ObjectDataSource7" DataTextField="TipoPrecioEscogido1" DataValueField="Abreviacion">
                                                            </telerik:RadComboBox>
                                                            <asp:ObjectDataSource ID="ObjectDataSource7" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Seleccionar_All" TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.TipoPrecioEscogidoFachada"></asp:ObjectDataSource>
                                                            <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="cboCiudad"
                                                                Display="Dynamic"  ValidationGroup="Edit"></asp:RequiredFieldValidator>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style="text-align: left;">
                                                            <telerik:RadTextBox ID="txtIdentificacion" runat="server" MaxLength="100" Text='<%# Bind("Identificacion") %>'
                                            ...
                                            <telerik:RadPageView ID="rpvContactos" runat="server">
                                                ...
                                                <table>
                                                    <tr>
                                                        <td>
                                                            <asp:FormView ID="frmCliente_Contacto" runat="server" DataKeyNames="Id" DataSourceID="ObjectDataSource5"
                                                                DefaultMode="Insert" OnItemInserted="frmCliente_Contacto_ItemInserted" OnItemInserting="frmCliente_Contacto_ItemInserting"
                                                                OnItemUpdated="frmCliente_Contacto_ItemUpdated" CssClass="CentrarElemento" OnDataBound="frmCliente_Contacto_DataBound">
                                                                <EditItemTemplate>
                                                                    <asp:HiddenField ID="hdfId" runat="server" Value='<%# Bind("Id") %>' />
                                                                    <asp:HiddenField ID="hdfId_Cliente" runat="server" Value='<%# Bind("Id_Cliente") %>' />
                                                                    <table class="CentrarElemento">
                                                                        ...
                                                                        <tr>
                                                                            ...
                                                                            <td>
                                                                                <asp:RadioButton ID="rdEstado" runat="server" Checked='<%# Bind("Estado") %>'
                                                                                    GroupName="Estado2" Text="Habilitado" />
                                                                                <asp:RadioButton ID="RadioButton2" runat="server"
                                                                                    Checked='<%# Bind("EstadoInv") %>' GroupName="Estado2" Text="Deshabilitado" />
                                                                            </td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="text-align: right;">
                                                            ...
                                                            <asp:ObjectDataSource ID="ObjectDataSource5" runat="server" DataObjectTypeName="SIGED_3.CRM.Model.Negocio.Entidades.Cliente_Contacto"
                                                                InsertMethod="Guardar" OldValuesParameterFormatString="original_{0}" SelectMethod="Seleccionar_Id"
                                                                TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.Cliente_ContactoFachada" UpdateMethod="Actualizar">
                                                                <SelectParameters>
                                                    ...
                                                    <tr>
                                                        <td>
                                                            <asp:GridView ID="gvCliente_Contactos" runat="server" AutoGenerateColumns="False"
                                                                DataSourceID="ObjectDataSource6" DataKeyNames="Id" OnSelectedIndexChanged="gvCliente_Contactos_SelectedIndexChanged"
                                                                OnRowCreated="gvCliente_Contactos_RowCreated">
                                                                <Columns>
                                                                    <asp:TemplateField>
                                                                        <HeaderTemplate>
                                                            ...
                                                            <asp:ObjectDataSource ID="ObjectDataSource6" runat="server" OldValuesParameterFormatString="original_{0}"
                                                                SelectMethod="Seleccionar_By_Cliente" TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.Cliente_ContactoFachada">
                                                                <SelectParameters>
                                                                    <asp:ControlParameter ControlID="hdfId" Name="Id_Cliente" PropertyName="Value" Type="Int32" />
                                                                </SelectParameters>
                                                            </asp:ObjectDataSource>
                                                        </td>
                                                    </tr>
                                    ...
                                    <InsertItemTemplate>
                                        <table class="CentrarElemento">
                                            ...
                                            <tr>
                                                ...
                                                <td style="text-align: left;">
                                                    <telerik:RadComboBox ID="cboPrecioQueSeVende" runat="server" SelectedValue='<%# Bind("PrecioQueSeVende") %>' DataSourceID="ObjectDataSource5" DataTextField="TipoPrecioEscogido1" DataValueField="Abreviacion">
                                                    </telerik:RadComboBox>
                                                    <asp:ObjectDataSource ID="ObjectDataSource5" runat="server" OldValuesParameterFormatString="original_{0}" SelectMethod="Seleccionar_All" TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.TipoPrecioEscogidoFachada"></asp:ObjectDataSource>
                                                    <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="cboCiudad"
                                                        Display="Dynamic"  ValidationGroup="Insert"></asp:RequiredFieldValidator>
                                                </td>
                                            </tr>
