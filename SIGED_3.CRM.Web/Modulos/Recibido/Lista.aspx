<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Ppal.Master" AutoEventWireup="true" CodeBehind="Lista.aspx.cs" Inherits="SIGED_3.CRM.Web.Modulos.Recibido.Lista" %>
<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.: Recibido Lista :.</title>
</asp:Content>
                ...
                <tr>
                    <th>Recibidos
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="Seleccionar_LP" TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.RecibidosFachada">
                            <SelectParameters>
                            ...
                            <td>
                                <asp:GridView ID="gvPrincipal" runat="server" AllowPaging="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="ConsecutivoPedido" HeaderText="Consecutivo Pedido" SortExpression="ConsecutivoPedido" />
                                        <asp:BoundField DataField="ConsecutivoOrden" HeaderText="Consecutivo Orden de Trabajo" SortExpression="ConsecutivoOrden" />
                                        <asp:BoundField DataField="NombreCliente" HeaderText="Cliente" SortExpression="NombreCliente" />
                                        <asp:BoundField DataField="EstadoORecibido" HeaderText="Estado" SortExpression="EstadoORecibido" />
                                        <asp:BoundField DataField="FechaGeneracion" HeaderText="Fecha de Recibido" SortExpression="FechaGeneracion" />
                                    </Columns>
                                </asp:GridView>
                            </td>
                        </tr>
