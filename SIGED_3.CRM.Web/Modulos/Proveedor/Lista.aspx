<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Ppal.Master" AutoEventWireup="true"
    CodeBehind="Lista.aspx.cs" Inherits="SIGED_3.CRM.Web.Modulos.Proveedor.Lista" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.: Proveedor Lista :.</title>
</asp:Content>
                ...
                <tr>
                    <th>Proveedores
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="Seleccionar_LP" TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.ProveedorFachada">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="rdEstado" Name="Estado" PropertyName="Checked" Type="Boolean" />
                                <asp:ControlParameter ControlID="txtIdentificacion" Name="identificacion" PropertyName="Text"
                                    Type="String" />
                ...
                <td>
                    <table class="CentrarElemento">
                        ...
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <telerik:RadTextBox ID="txtIdentificacion" runat="server" MaxLength="100" Width="200px">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td style="text-align: left;">
                                <telerik:RadTextBox ID="txtNombre" runat="server" MaxLength="100" Width="200px">
                                </telerik:RadTextBox>
                            </td>
                        </tr>
                    </table>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gvPrincipal" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
                                    AllowPaging="True" OnRowCreated="gvPrincipal_RowCreated">
                                    <Columns>
                                        <asp:TemplateField>
                                            <HeaderTemplate>
                                        ...
                                        <asp:BoundField DataField="Identficacion" HeaderText="Identificación" SortExpression="Identficacion" />
                                        <asp:BoundField DataField="Tipo" HeaderText="Tipo" SortExpression="Tipo" />
                                        <asp:BoundField DataField="Nombre" HeaderText="Nombre" SortExpression="Nombre" />
                                        <asp:BoundField DataField="Telefono_1" HeaderText="Telefono 1" SortExpression="Telefono_1" />
                                        <asp:BoundField DataField="Telefono_2" HeaderText="Telefono 2" SortExpression="Telefono_2" />
