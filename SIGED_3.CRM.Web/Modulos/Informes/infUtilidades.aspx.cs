...
{
    public partial class infUtilidades : System.Web.UI.Page
    {
        ...
        protected void btnGenerar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            rptViewer.LocalReport.ReportPath = "Modulos\\Informes\\infUtilidades.rdlc";
            ...
            ReportDataSource ObjReport_2 = new ReportDataSource("dtsUtilidades", new CostoFachada().Informe_Utilidades(SessionManager.Id_GrupoDeMiembros, dtDesde.SelectedDate, dtHasta.SelectedDate));
