...
{
    public partial class infPlanDeCompras : System.Web.UI.Page
    {
        ...
        protected void btnGenerar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            rptViewer.LocalReport.ReportPath = "Modulos\\Informes\\infPlanDeCompras.rdlc";
            ...
            ReportDataSource ObjReport_2 = new ReportDataSource("dtsPlanDeCompras", new PedidoFachada().RelatorioDePlanDeCompras((long?)txtConsecutivo.Value, SessionManager.Id_GrupoDeMiembros));
