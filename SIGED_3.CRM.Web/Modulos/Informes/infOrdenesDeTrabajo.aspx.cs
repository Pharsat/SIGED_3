...
{
    public partial class infOrdenesDeTrabajo : System.Web.UI.Page
    {
        ...
        protected void btnGenerar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            rptViewer.LocalReport.ReportPath = "Modulos\\Informes\\infOrdenesDeTrabajo.rdlc";
            ...
            ReportDataSource ObjReport_2 = new ReportDataSource("dtsOrdenesDeTrabajo", new OrdenesDeTrabajoFachada().RelatorioDeOrdenesDeTrabajo((long?)txtConsecutivo.Value, SessionManager.Id_GrupoDeMiembros));
