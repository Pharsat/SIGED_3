...
{
    public partial class infLista_Precios : System.Web.UI.Page
    {
        ...
        protected void btnGenerar_Click(object sender, ImageClickEventArgs e)
        {
            ...
            rptViewer.LocalReport.ReportPath = "Modulos\\Informes\\infLista_Precios.rdlc";
            ...
            ReportDataSource ObjReport_2 = new ReportDataSource("dtsLista", new CostoFachada().Impresion_Lista_Precios(SessionManager.Id_GrupoDeMiembros));
