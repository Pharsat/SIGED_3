<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage/Ppal.Master" AutoEventWireup="true"
    CodeBehind="Lista.aspx.cs" Inherits="SIGED_3.CRM.Web.Modulos.FichaTecnica.Lista" %>

<%@ Register Assembly="Telerik.Web.UI" Namespace="Telerik.Web.UI" TagPrefix="telerik" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
    <title>.: Ficha Tecnica Lista :.</title>
</asp:Content>
                ...
                <tr>
                    <th>Fichas Tecnicas
                        <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}"
                            SelectMethod="Seleccionar_LP" TypeName="SIGED_3.CRM.Model.Servicios.Fachadas.FichaTecnicaFachada">
                            <SelectParameters>
                                ...
                                <asp:ControlParameter ControlID="txtTipoDePrenda" Name="tipoPrenda" PropertyName="Text"
                                    Type="String" />
                            </SelectParameters>
                            ...
                            <td>
                                <asp:GridView ID="gvPrincipal" runat="server" AutoGenerateColumns="False" DataSourceID="ObjectDataSource1"
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="TipoPrenda" HeaderText="TipoPrenda" SortExpression="TipoPrenda" />
                                        <asp:BoundField DataField="FechaActualizacion" HeaderText="FechaActualizacion" SortExpression="FechaActualizacion" />
                                    </Columns>
                                </asp:GridView>
                            </td>
                        </tr>
