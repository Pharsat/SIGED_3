...
{
    [DataObject(true)]
    public class FichaTecnica_HiloFachada
    {
        /// <summary>
        ...
        {
            FichaTecnica_HiloLN objFichaTecnica_Hilo = new FichaTecnica_HiloLN();
        ...
        {
            FichaTecnica_HiloLN _objFichaTecnica_Hilo = new FichaTecnica_HiloLN();
