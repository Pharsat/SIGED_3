...
{
    [DataObject(true)]
    public class Proveedor_ContactoFachada
    {
        /// <summary>
        ...
        {
            Proveedor_ContactoLN objProveedor_Contacto = new Proveedor_ContactoLN();
        ...
        {
            Proveedor_ContactoLN _objProveedor_Contacto = new Proveedor_ContactoLN();
