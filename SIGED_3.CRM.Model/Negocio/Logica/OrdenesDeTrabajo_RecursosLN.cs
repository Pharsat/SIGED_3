...
{
    internal class OrdenesDeTrabajo_RecursosLN
    {
        /// <summary>
        ...
        {
            OrdenesDeTrabajo_RecursosOAD objOrdenesDeTrabajo_Recursos = new OrdenesDeTrabajo_RecursosOAD();
        ...
        {
            OrdenesDeTrabajo_RecursosOAD _objOrdenesDeTrabajo_Recursos = new OrdenesDeTrabajo_RecursosOAD();
